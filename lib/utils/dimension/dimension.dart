...
class Dimensions {
  ...
  static double screenHeight = AppSizes.instance.screenSize.height;
  static double screenWidth = AppSizes.instance.screenSize.width;
...
// Height
  ...
  static double height_160 = getHeight(160);
  ...
  static double width_190 = getWidth(190);
